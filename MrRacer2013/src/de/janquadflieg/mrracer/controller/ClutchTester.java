 ...
 */
public final class ClutchTester
    ...
    private static final String[] ALTERNATIVE_PARAMETERS = {};//"/de/janquadflieg/mrracer/data/mrracer2012mueda"};
    ...
    public ClutchTester(Telemetry t) {
        this(t, DEFAULT_PARAMETERS, true);
    }

    public ClutchTester(Telemetry t, String s, boolean loadFromCP) {
        super(t);
    ...
    public scr.Action unsaveControl(scr.SensorModel model) {
        ...
        if (canHandle(data)) {
            ...
            acceleration.setTargetSpeed(330.0);
            ...
            steering.setTargetPosition(new Point2D.Double(targetPosition, Math.max(0.2, (data.getSpeed() / 3.6) / 50)));
            ...
            //System.out.println("Backup"+System.currentTimeMillis());
