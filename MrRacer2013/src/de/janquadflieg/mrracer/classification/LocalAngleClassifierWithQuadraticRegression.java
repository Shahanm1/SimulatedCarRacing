 ...
 * @author quad
 */
public class LocalAngleClassifierWithQuadraticRegression {
    ...
    public LocalAngleClassifierWithQuadraticRegression() {
        // init angles
        for (int i = 0; i < 19; ++i) {
            angles[i] = -90 + i * 10;
        }
    ...
    /*private static double sumAngles(Vector2d[] vectors) {
        double result = 0;
