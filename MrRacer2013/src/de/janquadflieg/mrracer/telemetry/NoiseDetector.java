...
public class NoiseDetector {
    ...
    private ArrayList<SensorData> buffer = new ArrayList<>(25);

    private ArrayList<double[]> bufferW = new ArrayList<>();
    ...
    public SensorData filterNoise(SensorData data) {
        ...
        for (int i = 0; i < opponentSensor.length; ++i) {
            ...
            if (data.getOpponentSensors()[i] < Observer2012.MAX_DISTANCE_NOISY) {
                //System.out.print(i);
                ...
                for (int j = 0; j < buffer.size(); ++j) {
                    ...
                    if (v < Observer2012.MAX_DISTANCE_NOISY) {
                        opponentSensor[i] += v;
                        numValues++;
                    }
                }
