...
public class SensorData {
    ...
    /** 19 Track sensors, filtered if nessecary. */
    protected double[] trackSensors = new double[19];
    /** 19 Track sensors, raw values without filtering. */
    protected double[] rawTrackSensors = new double[19];
    /** 18 Opponent sensors. */
    ...
    public SensorData() {
        for (int i = 0; i < trackSensors.length; ++i) {
            ...
            rawTrackSensors[i] = Utils.NO_DATA_D;
        }
    ...
    public SensorData(SensorModel m) {
        ...
        filterWrong();
        System.arraycopy(trackSensors, 0, rawTrackSensors, 0, rawTrackSensors.length);
    }
...
//        }
    ...
    public SensorModel getSensorModel(){
        ...
        return new scr.MessageBasedSensorModel(sb.toString());
    }
    ...
    public double[] getRawTrackEdgeSensors() {
        return this.rawTrackSensors;
    }
    ...
    public static void main(String[] args){
        for(double i = 1.0; i >= -1.0; i=i-0.1){
            double abs = SensorData.calcAbsoluteTrackPosition(i, 12.0);
            double rel = SensorData.calcRelativeTrackPosition(abs, 12.0);
            System.out.println(Utils.dTS(i)+" = "+Utils.dTS(abs)+" = "+Utils.dTS(rel));
        }
    }
}
