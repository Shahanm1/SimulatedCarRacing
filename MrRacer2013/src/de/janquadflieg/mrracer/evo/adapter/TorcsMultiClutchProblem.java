...
import de.janquadflieg.mrracer.behaviour.ClutchMulti;
 ...
 * @author quad
 */
public class TorcsMultiClutchProblem
extends Problem implements ParallelEvaluableProblem{
    ...
    public TorcsMultiClutchProblem(Parameters par) {
    ...
    public Evaluation evaluate(Individual variables, int offset) {
        ...
        // parameters for the clutch, 1st gear
        v = (RealVariable)variables.getAnyVariable("CLUTCH_1ST_B");
        params.setProperty(MrRacer2012.CLUTCH+ClutchMulti.GEAR1+Clutch.F+GeneralisedLogisticFunction.GROWTH_RATE_B,
                String.valueOf(Math.pow(10, v.toDouble())));

        v = (RealVariable)variables.getAnyVariable("CLUTCH_1ST_M");
        params.setProperty(MrRacer2012.CLUTCH+ClutchMulti.GEAR1+Clutch.F+GeneralisedLogisticFunction.M,
                String.valueOf(v.toDouble()));

        v = (RealVariable)variables.getAnyVariable("CLUTCH_1ST_V");
        params.setProperty(MrRacer2012.CLUTCH+ClutchMulti.GEAR1+Clutch.F+GeneralisedLogisticFunction.V,
                String.valueOf(v.toDouble()));

        v = (RealVariable)variables.getAnyVariable("CLUTCH_1ST_Q");
        params.setProperty(MrRacer2012.CLUTCH+ClutchMulti.GEAR1+Clutch.F+GeneralisedLogisticFunction.Q,
                String.valueOf(v.toDouble()));

        // parameters for the clutch, 2nd gear
        v = (RealVariable)variables.getAnyVariable("CLUTCH_2ND_B");
        params.setProperty(MrRacer2012.CLUTCH+ClutchMulti.GEAR2+Clutch.F+GeneralisedLogisticFunction.GROWTH_RATE_B,
                String.valueOf(Math.pow(10, v.toDouble())));

        v = (RealVariable)variables.getAnyVariable("CLUTCH_2ND_M");
        params.setProperty(MrRacer2012.CLUTCH+ClutchMulti.GEAR2+Clutch.F+GeneralisedLogisticFunction.M,
                String.valueOf(v.toDouble()));

        v = (RealVariable)variables.getAnyVariable("CLUTCH_2ND_V");
        params.setProperty(MrRacer2012.CLUTCH+ClutchMulti.GEAR2+Clutch.F+GeneralisedLogisticFunction.V,
                String.valueOf(v.toDouble()));

        v = (RealVariable)variables.getAnyVariable("CLUTCH_2ND_Q");
        params.setProperty(MrRacer2012.CLUTCH+ClutchMulti.GEAR2+Clutch.F+GeneralisedLogisticFunction.Q,
                String.valueOf(v.toDouble()));
    ...
    public Individual getTemplate(Parameters par) {
        ...
        genotype.add(new RealVariable("CLUTCH_1ST_B", 0, 1, true));
        genotype.add(new RealVariable("CLUTCH_1ST_M", 0, 1, true));
        genotype.add(new RealVariable("CLUTCH_1ST_V", 0, 1, true));
        genotype.add(new RealVariable("CLUTCH_1ST_Q", 0, 1, true));

        genotype.add(new RealVariable("CLUTCH_2ND_B", 0, 1, true));
        genotype.add(new RealVariable("CLUTCH_2ND_M", 0, 1, true));
        genotype.add(new RealVariable("CLUTCH_2ND_V", 0, 1, true));
        genotype.add(new RealVariable("CLUTCH_2ND_Q", 0, 1, true));
    ...
    public static void main(String[] args) {
        ...
        BlackBoxProblem prob = new TorcsMultiClutchProblem(par);
