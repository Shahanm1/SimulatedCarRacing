...
public class VisualizationFrame
    ...
    private scr.Controller controller = null;
    ...
    public VisualizationFrame() {
        ...
        while (it.hasNext()) {
            ...
            if (ci.toString().equalsIgnoreCase("MrRacer2013")) {
                toSelect = ci;
            }
        }
        for (int i = 0; i < scr.Controller.Stage.values().length; ++i) {
            this.jcbStage.addItem(scr.Controller.Stage.values()[i]);
        }
        ...
        for (int i = 0; i < trackDB.size(); ++i) {
            if (!trackDB.get(i).getName().equalsIgnoreCase(TrackDB.PRECOMPILE_TRACK)) {
        ...
        //this.jcbTrack.getEditor().setItem("test");
        this.jcbTrack.setSelectedItem("wheel2");
        ...
        jcbStage.setSelectedItem(scr.Controller.Stage.RACE);
...
//        }
    ...
    private void toggleGui(boolean b) {
        jcbRecordTelemetry.setEnabled(b);
        jbControllerStop.setEnabled(!b);
        jbControllerStart.setEnabled(b);
        jcbController.setEnabled(b);
        jtfServer.setEnabled(b);
        jcbStage.setEnabled(b);
        jcbTrack.setEnabled(b);
        jbSelectParameterSet.setEnabled(b);
    }   
    ...
    private void initComponents() {
        ...
        jcbController = new javax.swing.JComboBox<Configuration.ControllerInfo>();
        jLabel23 = new javax.swing.JLabel();
        jtfServer = new javax.swing.JTextField();
        jLabel24 = new javax.swing.JLabel();
        jcbStage = new javax.swing.JComboBox<scr.Controller.Stage>();
        jLabel2 = new javax.swing.JLabel();
        jcbRecordTelemetry = new javax.swing.JCheckBox();
        jcbTrack = new javax.swing.JComboBox<String>();
        jLabel16 = new javax.swing.JLabel();
        jtfParameterSet = new javax.swing.JTextField();
        jbSelectParameterSet = new javax.swing.JButton();
        ...
        jlTelemetryLapData = new javax.swing.JLabel();
        jcbTelemetryLaps = new javax.swing.JComboBox<String>();
        ...
        jcbmiTSParallel = new javax.swing.JCheckBoxMenuItem();
        ...
        jcbmiOSNewInterpretation = new javax.swing.JCheckBoxMenuItem();
        ...
        jtfParameterSet.setColumns(15);
        jtfParameterSet.setEditable(false);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 8;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        jPanel4.add(jtfParameterSet, gridBagConstraints);

        jbSelectParameterSet.setText("Select");
        jbSelectParameterSet.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jbSelectParameterSetActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        ...
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.insets = new java.awt.Insets(0, 2, 0, 5);
        jPanel4.add(jbSelectParameterSet, gridBagConstraints);

        jPanel8.setLayout(new java.awt.GridBagLayout());

        jbControllerStart.setText("Start");
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        jPanel8.add(jbControllerStart, gridBagConstraints);

        jbControllerStop.setText("Stop");
        ...
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 0;
        jPanel8.add(jbControllerStop, gridBagConstraints);
        ...
        jtfControllerLog.setColumns(20);
        ...
        jPanel7.setBorder(javax.swing.BorderFactory.createTitledBorder("Telemetry Display"));
        jPanel7.setEnabled(false);
        jPanel7.setLayout(new java.awt.GridBagLayout());

        jlTelemetryLapData.setText("Lap");
        jPanel7.add(jlTelemetryLapData, new java.awt.GridBagConstraints());

        jcbTelemetryLaps.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                jcbTelemetryLapsItemStateChanged(evt);
            }
        });
        jPanel7.add(jcbTelemetryLaps, new java.awt.GridBagConstraints());
        ...
        jcbmiTSParallel.setText("Parallel Coordinates");
        jcbmiTSParallel.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                jcbmiTSParallelItemStateChanged(evt);
            }
        });
        jMenu2.add(jcbmiTSParallel);
        ...
        jMenu3.setText("Opponent Sensor");

        jcbmiOSNewInterpretation.setSelected(true);
        jcbmiOSNewInterpretation.setText("New Interpretation");
        jcbmiOSNewInterpretation.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                jcbmiOSNewInterpretationItemStateChanged(evt);
            }
        });
        jMenu3.add(jcbmiOSNewInterpretation);
    ...
    private void startController() {
        try {
            ...
            if (jtfParameterSet.getText() != null
                    && !jtfParameterSet.getText().trim().isEmpty()) {

                System.out.println("Parameter file: " + jtfParameterSet.getText());

                System.setProperty("EAMode", "");
                System.setProperty(de.janquadflieg.mrracer.controller.MrRacer2012.PARAM_FILE, jtfParameterSet.getText());

                /*Properties p = new Properties();
                InputStream in = new FileInputStream(jtfParameterSet.getText());
                p.load(in);
                in.close();*/
            ...
            if (jcbRecordTelemetry.isSelected()) {
                ...
                controller = (scr.Controller) constructor.newInstance(telemetry);

            } else {
                java.lang.reflect.Constructor<?> constructor = c.getConstructor();
                controller = (scr.Controller) constructor.newInstance();
            }
            controller.setStage((scr.Controller.Stage) jcbStage.getSelectedItem());
    ...
    private void loadTelemetry(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loadTelemetry
        // TODO add your handling code here:
        fileChooser.setFileSelectionMode(JFileChooser.FILES_ONLY);
        fileChooser.setAcceptAllFileFilterUsed(true);
        fileChooser.setMultiSelectionEnabled(false);
        ...
        // test
        telemetry.load(fileChooser.getSelectedFile().getAbsolutePath());
    }//GEN-LAST:event_loadTelemetry

    private void jcbTelemetryLapsItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jcbTelemetryLapsItemStateChanged
        int i = this.jcbTelemetryLaps.getSelectedIndex();
        if(i != -1){
            telemetryDisplay.setLap(i);
            //String s = "[" + telemetry.getLapStartIndex(i) + " - " + telemetry.getLapEndIndex(i) + "]";
            //jlTelemetryLapData.setText(s);
        }
    }//GEN-LAST:event_jcbTelemetryLapsItemStateChanged

    private void jcbmiTSParallelItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jcbmiTSParallelItemStateChanged
        trackSensorDisplay.setDrawCoordinatesParallel(jcbmiTSParallel.getState());
        jcbmiTSCapOff.setEnabled(!jcbmiTSParallel.getState());
        jcbmiTSCoordinates.setEnabled(!jcbmiTSParallel.getState());
        jcbmiTSOutline.setEnabled(!jcbmiTSParallel.getState());
        jcbmiTSSensors.setEnabled(!jcbmiTSParallel.getState());
    }//GEN-LAST:event_jcbmiTSParallelItemStateChanged

    private void jbSelectParameterSetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbSelectParameterSetActionPerformed
        // TODO add your handling code here:
        java.io.File directory = new java.io.File("F:\\Quad\\svn\\TORCS\\TCIAIG-2011\\experiments");
        ...
        jtfParameterSet.setText(fileChooser.getSelectedFile().getAbsolutePath());
    }//GEN-LAST:event_jbSelectParameterSetActionPerformed

    private void jcbmiOSNewInterpretationItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jcbmiOSNewInterpretationItemStateChanged
        // TODO add your handling code here:
        opponentSensorDisplay.setMode(this.jcbmiOSNewInterpretation.isSelected());
    }//GEN-LAST:event_jcbmiOSNewInterpretationItemStateChanged
    ...
    private void stoppedEDT(){
        ...
        jcbTelemetryLaps.removeAllItems();
        for (int i = 0; i < telemetry.getNumLaps(); ++i) {
            jcbTelemetryLaps.addItem(String.valueOf(i));
        }
        toggleGui(true);
    ...
    public void loaded() {
        ...
        if(jcbTelemetryLaps.getItemCount() == 0){
            telemetryDisplay.setLap(-1);
        } else {
            telemetryDisplay.setLap(Integer.parseInt(jcbTelemetryLaps.getSelectedItem().toString()));
        }
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                JFrame frame = new VisualizationFrame();
            }
        });
    }
    ...
    private javax.swing.JButton jbSelectParameterSet;
    private javax.swing.JComboBox<Configuration.ControllerInfo> jcbController;
    private javax.swing.JCheckBox jcbRecordTelemetry;
    private javax.swing.JComboBox<scr.Controller.Stage> jcbStage;
    private javax.swing.JComboBox<String> jcbTelemetryLaps;
    private javax.swing.JComboBox<String> jcbTrack;
    private javax.swing.JCheckBoxMenuItem jcbmiOSNewInterpretation;
    ...
    private javax.swing.JCheckBoxMenuItem jcbmiTSParallel;
    private javax.swing.JCheckBoxMenuItem jcbmiTSSensors;
    private javax.swing.JLabel jlTelemetryLapData;
    ...
    private javax.swing.JTextField jtfParameterSet;
