...
public class OnlineLearning2011 {
    ...
    private static final boolean TEXT_DEBUG = true;
    /** The controller. */
    private BaseController controller;

    /** Data collected during the learning process. */
    private ArrayList<LapData> metaNew = new ArrayList<>(30);

    private ArrayList<DataSet> meta = new ArrayList<>();
    
    private double start = 0.0;
    private double nextLap = 0.0;
    /** Number of laps driven without problems. */
    private int lapsOK = 0;
    /** The last sensordata. */
    private SensorData lastData;
    /** The trackmodel. */
    private TrackModel trackModel;
    /** Times needed for the various phases of the learning process. */
    ...
    private ArrayList<Double> testingTimes = new ArrayList<>();
    ...
    private void updateGoingFaster(boolean justSwitched) {
        ...
        if (allOK) {
            ...
            if (offLastTwoSegments) {
                ...
                if (TEXT_DEBUG) {
                    System.out.println("On track in last two segments, pretending that I completed one lap without problems");
                }
                lapsOK = 1;
            }
        }
    ...
    public void saveData() {
        ...
        if(times[0] != Long.MAX_VALUE){
            double seconds = times[1] / 1000.0;
            System.out.println("Learning the trackmodel took " + Utils.timeToExactString(seconds));
        }
    ...
    static class LapData extends ArrayList<DataSet>{
        ...
        public LapData(TrackModel model, int lap){
            super(model.size());
            this.lap = lap;
